...
/**
 * Class that implements tests of the PaymentService features.
 */
...
class PaymentServiceImplTest {
    ...
    public void shouldMakePayment() {
        ...
        Mockito.when(moneyTransferService.makePayment(paymentRequest)).thenReturn(expectedPaymentDetails);

        //act
        PaymentDetails actualPaymentDetails = paymentService.makePayment(paymentRequest);
